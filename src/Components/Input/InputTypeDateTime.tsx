...
interface InputTypeDateTimeProps<T extends FieldValues> extends UseControllerProps<T> {
  title: string;
  placeholder: string;
}
        ...
        <div className="w-full min-w-[200px] mb-5">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              onChange(ConvertDateTime(dateValue)); // Cập nhật giá trị với react-hook-form
            }}
