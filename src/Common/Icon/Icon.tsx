...
export const IconCalender: React.FC<IconProps> = ({
  width = "2em",
  height = "2em",
  color = "#fff"
}) => {
...
export const IconSuccess = () => {
  return (
    ...
    >
      ...
      <path fill="#00FF00" d="M0 0h48v48H0z" mask="url(#ipSSuccess0)" /> 
    </svg>
  );
};
export const IconFailTransaction = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="50"
    ...
    >
      <path
        ...
        stroke-linejoin="round"
        stroke-width="4"
        d="M38 4H10a2 2 0 0 0-2 2v36a2 2 0 0 0 2 2h28a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2M17 30h14m-14 6h7m-4-15l8-8m0 8l-8-8"
      />
    </svg>
  );
};
