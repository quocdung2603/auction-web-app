...
import ShowProjectBig from "./Components/ShowProduct";
import { Auction, ResponseAuctionData } from "../../../Type/Auction/AuctionSession";
...
const AssetListPage = () => {
  ...
  const getAllAuction = async () => {
    const res: ResponseAuctionData = await AuctionSessionServices.getAll();
	setListAuction(res.metadata.auctionSessions);
  };
    ...
    <>
      <div className="px-custom ">
        <div className="flex flex-col h-[200px] justify-center border-b-2">
          <h1 className="text-3xl font-semibold mb-4">Danh mục tài sản</h1>
        ...
        <div className="flex gap-4 mt-4 bg-transparent">
          ...
          >
            <div className="w-full shadow-custom rounded px-4 py-6 mb-8">
              <h1 className="text-2xl font-semibold mb-4">Tìm kiếm</h1>
              <input
                type="text"
              ...
              <div className="flex gap-6 flex-wrap mb-4">
                <div className="flex-1 min-w-[90px]">
                  <h2 className="text-lg font-semibold">Từ ngày</h2>
                ...
                <div className="flex-1 min-w-[90px]">
                  <h2 className="text-lg font-semibold">Đến ngày</h2>
                  <div className="relative">
                    <DatePicker
          ...
          <div className="w-[75%]">
            ...
            >
              {listAuction.map((product, index) => (
                <ShowProjectBig key={index} auction={product}/>
              ))}
            </div>
          </div>
        </div>
