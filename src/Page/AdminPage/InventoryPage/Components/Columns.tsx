...
const Columns = (showModalEdit: (
  isOpen: boolean, data: Inventory) => void,
  showDeleteConfirm: (userId: string) => void
): TableColumnsType<Inventory> => [
    {
      ...
      width: "16.67%",
      align: "center",
      onFilter: (value, record) => record.inventoryID.toString().startsWith(value as string),
      //sorter
      defaultSortOrder: 'descend',
      sorter: (a, b) => a.inventoryID.toString().localeCompare(b.inventoryID.toString()),
      //render
      render(value, record) {
        return (
          <Link to={`/profile/${record.inventoryID}`} className="underline text-center">
            {value}
          </Link>
        );
      },
    },
    {
      ...
      width: "16.67%",
      align: "center",
      onFilter: (value, record) => record.assetID.toString().startsWith(value as string),
      //sorter
      defaultSortOrder: 'descend',
